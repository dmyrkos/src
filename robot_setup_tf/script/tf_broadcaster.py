...
dynamic_links =  {
                ...
                "RM" : { "A_RM":["RMH",0,-0.01,0,90,0,0], "RMH":["B_RM",0,-0.05,0,-90,0,0],  "C_RM":["RMK",0,0,0,0,45,0],   
                        "RMK":["D_RM",0,-0.027,0,0,0,0] , "E_RM":["RMA",0,0,0,0,45,0] , "RMA":["F_RM",0,-0.02,0,0,0,0]},
                "LM": { "A_LM":["LMH",0,0.01,0,90,0,0], "LMH":["B_LM",0,0.05,0,-90,0,0],  "C_LM":["LMK",0,0,0,0,45,0], 
                        "LMK":["D_LM",0,0.027,0,0,0,0] , "E_LM":["LMA",0,0,0,0,45,0] , "LMA":["F_LM",0,0.02,0,0,0,0]},
                "RB":  { "A_RB":["RBH",-0.01,0,0,90,0,-90], "RBH":["B_RB",-0.05,0,0,-90,0,0],  "C_RB":["RBK",0,0,0,0,45,0], 
                        "RBK":["D_RB",-0.027,0,0,0,0,0] , "E_RB":["RBA",0,0,0,0,45,0] , "RBA":["F_RB",-0.02,0,0,0,0,0]},
                "LB":  { "A_LB":["LBH",-0.01,0,0,-90,0,90], "LBH":["B_LB",-0.05,0,0,-90,0,0],  "C_LB":["LBK",0,0,0,0,45,0], 
